<?php
	...
	/**
	* THIS SOURCE CODE WAS AUTOMATICALLY GENERATED ON Tue 10:33:29  19/01/2016
	* 
	*
...
class Oldage_sickness {
	...
	*/
	public function get_id_sickness($sickness,$sickness_info,$sickness_causes,$sickness_signs,$sickness_treatment,$sickness_treatment_precautions,$sickness_prevention,$sickness_caution,$sickness_note) {
		...
		$id_sickness_ = $this->query_from_oldage_sickness ( $columns, $records );
	...
	*/
	public function get_sickness($id_sickness) {
		...
		$sickness_ = $this->query_from_oldage_sickness ( $columns, $records );
	...
	*/
	public function get_sickness_info($id_sickness) {
		$columns = array ('id_sickness');
		$records = array ($id_sickness);
		$sickness_info_ = $this->query_from_oldage_sickness ( $columns, $records );
	...
	*/
	public function get_sickness_causes($id_sickness) {
		$columns = array ('id_sickness');
		$records = array ($id_sickness);
		$sickness_causes_ = $this->query_from_oldage_sickness ( $columns, $records );
	...
	*/
	public function get_sickness_signs($id_sickness) {
		$columns = array ('id_sickness');
		$records = array ($id_sickness);
		$sickness_signs_ = $this->query_from_oldage_sickness ( $columns, $records );
	...
	*/
	public function get_sickness_treatment($id_sickness) {
		$columns = array ('id_sickness');
		$records = array ($id_sickness);
		$sickness_treatment_ = $this->query_from_oldage_sickness ( $columns, $records );
	...
	*/
	public function get_sickness_treatment_precautions($id_sickness) {
		$columns = array ('id_sickness');
		$records = array ($id_sickness);
		$sickness_treatment_precautions_ = $this->query_from_oldage_sickness ( $columns, $records );
	...
	*/
	public function get_sickness_prevention($id_sickness) {
		$columns = array ('id_sickness');
		$records = array ($id_sickness);
		$sickness_prevention_ = $this->query_from_oldage_sickness ( $columns, $records );
	...
	*/
	public function get_sickness_caution($id_sickness) {
		$columns = array ('id_sickness');
		$records = array ($id_sickness);
		$sickness_caution_ = $this->query_from_oldage_sickness ( $columns, $records );
	...
	*/
	public function get_sickness_note($id_sickness) {
		$columns = array ('id_sickness');
		$records = array ($id_sickness);
		$sickness_note_ = $this->query_from_oldage_sickness ( $columns, $records );
	...
	* @return Table Name [oldage_sickness] 
	*/
	public static function get_table() {
		return 'oldage_sickness';
	}
	...
	*/
	...
	/**
	* Used  to calculate the number of times a record exists in the table [oldage_sickness]
	*
	* @return the number of times a record exists exists in the table [oldage_sickness]
	*/
	...
	/**
	* Inserts data into the table[oldage_sickness]
	*
	* @return 1 if data was inserted,0 otherwise
	*/
	public function insert_records_to_oldage_sickness(Array $columns, Array $records, $printSQL = false) {
		return $this->insert_records ( $this->get_table (), $columns, $records, $printSQL );
	}
	
	/**
	* Deletes all the records that meets the passed criteria from the table [oldage_sickness]
	*  
	* @return number of deleted rows
	*/
	public function delete_record_from_oldage_sickness(Array $columns, Array $records, $printSQL = false) {
		return $this->delete_record ( $this->get_table (), $columns, $records, $printSQL );
	}
	
	/**
	* updates all the records that meets the passed criteria from the table [oldage_sickness]
	*  
	* @return number of updated rows
	*/
	public function update_record_in_oldage_sickness(Array $columns, Array $records, Array $where_columns, Array $where_records, $printSQL = false) {
		return $this->update_record ( $this->get_table (), $columns, $records, $where_columns, $where_records, $printSQL );
	}
	
	/**
	* Gets an Associative array of the records in the table [oldage_sickness] that meets the passed criteria
	*  
	* @return associative array of the records that are found after performing the query
	*/
	public function fetch_assoc_in_oldage_sickness(Array $columns, Array $records, $printSQL = false) {
	...
	* @return associative array of the records that are found after performing the query
	*/
	public function query_from_oldage_sickness(Array $columns, Array $records, $printSQL = false) {
	...
	* @return associative array of the records that are found after performing the query
	*/
	public function search_in_oldage_sickness(Array $columns, Array $records, $printSQL = false) {
