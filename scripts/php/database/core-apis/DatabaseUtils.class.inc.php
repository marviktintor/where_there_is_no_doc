...
class DatabaseUtils {
	...
	public function __construct($host = "localhost", $user = "root", $password = "", $database = "where_there_is_no_doc") {
		
		require_once 'C:\xampp\htdocs\where_there_is_no_doc\scripts\php\database\core-apis\DatabaseConnection.class.inc.php';
